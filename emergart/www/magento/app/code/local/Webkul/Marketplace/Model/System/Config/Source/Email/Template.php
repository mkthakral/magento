<?php
/**
 * Webkul Marketplace Adminhtml config system template source
 *
 * @category    Webkul
 * @package     Webkul_Marketplace
 * @author      Webkul Software Private Limited 
 */
class Webkul_Marketplace_Model_System_Config_Source_Email_Template extends Varien_Object
{
    /**
    ...
    public function toOptionArray()
    {
        ...
        $node_path_arr = explode('marketplace/email_option/', $this->getPath());
        $nodeName = $node_path_arr[1];
