...
class Inchoo_SocialConnect_Helper_Facebook extends Mage_Core_Helper_Abstract
{
            ...
            $token)
    {
		...
		$type= Mage::getModel('core/cookie')->get('socialtype');
		//echo "type".$type;exit;
		$customernew=Mage::getModel('customer/customer')->load($customer->getId());
		$customernew->setGroupId($type);
		$customernew->save();
        ...
        Mage::getSingleton('core/session')->unsType();
