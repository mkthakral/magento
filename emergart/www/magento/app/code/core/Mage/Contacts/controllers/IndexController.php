        ...
        if ( $post ) {
            ...
            try {
                ...
                if (Zend_Validate::is(trim($post['hideit']), 'NotEmpty')) {
                 ...
                 if ( $captcha == '' ) {
                    $captchaErrorBoolean = true;
                    $captchaErrorMessage = "Please check the CAPTCHA checkbox to submit the form.";
                 } else {
                    ...
                    if ( trim( $result['success'] ) != true ) {
                        ...
                        $captchaErrorBoolean = true;
                        $captchaErrorMessage = "CAPTCHA verification failed. Are you a bot?";
                    }
                }

                if ($error || $captchaErrorBoolean) {
                    throw new Exception();
                }
                ...
                if($captchaErrorBoolean){
                    Mage::getSingleton('customer/session')->addError(Mage::helper('contacts')->__($captchaErrorMessage));
                }else{
