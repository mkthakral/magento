...
class RevSliderWooCommerce{
	...
	public static function getCustomPostTypes(){
		...
		$arr["product_variation"] = __("Product Variation");
	...
	public static function getArrSortBy(){
		...
		$arrSortBy = array();
		$arrSortBy[self::SORTBY_REGULAR_PRICE] = __("Regular Price");
		$arrSortBy[self::SORTBY_SALE_PRICE] = __("Sale Price");
		$arrSortBy[self::SORTBY_NUMSALES] = __("Number Of Sales");
		$arrSortBy[self::SORTBY_FEATURED] = __("Featured Products");
		$arrSortBy[self::SORTBY_SKU] = __("SKU");
		$arrSortBy[self::SORTBY_STOCK] = __("Stock Quantity");
