...
class RevSliderSlider extends RevSliderElementsBase{
		...
		try{
            ...
            if( !Mage::helper('nwdrevslider/framework')->is_wp_error($unzipfile) ){
				...
				if(!empty($animations)){
					...
					Mage::helper('nwdrevslider/framework')->dmp(__("animations imported!"));
				}
				...
				if(is_array($dynamicCss) && $dynamicCss !== false && count($dynamicCss) > 0){
					...
					Mage::helper('nwdrevslider/framework')->dmp(__("dynamic styles imported!"));
				}
                ...
                if(!empty($navigations)){
                    ...
                    Mage::helper('nwdrevslider/framework')->dmp(__("navigations imported!"));
				}
            }else{
	 ...
	 */
	public function getSlidesFromGallery($publishedOnly = false, $storeID = 0, $allwpml = false){
