...
class RevSliderTemplate {
	...
	public function write_import_template_markup($template){
        ...
        <div class="template_thumb_more">
            ...
            if(isset($template['setup_notes']) && !empty($template['setup_notes'])){
                ?>
                <span class="ttm_label"><?php echo __('Setup Notes', 'revslider'); ?></span>
                <?php
            ...
            ?>
            <span class="ttm_label"><?php echo __('Requirements', 'revslider'); ?></span>
            <ul class="ttm_requirements">
                ...
                echo __('Slider Revolution Version', 'revslider');
            ...
            <span class="ttm_space"></span>
            <span class="ttm_label_direct"><?php echo __('Available Version', 'revslider'); ?></span>
            <span class="ttm_label_half ttm_available"><?php echo $template['version'];?></span>    
            <span class="ttm_space"></span>
            <?php
            if($deny == '' && $allow_install == true){
                ?>
                <div class="install_template_slider<?php echo $deny; ?>" data-zipname="<?php echo $template['zip']; ?>" data-uid="<?php echo $template['uid']; ?>"><i class="eg-icon-download"></i><?php echo __('Install Slider', 'revslider'); ?></div>                            
                <?php
                if(isset($template['package']) && $template['package'] !== ''){
                    ?>
                    <span class="tp-clearfix" style="margin-bottom:5px"></span>
                    <div class="install_template_slider_package<?php echo $deny; ?>" data-zipname="<?php echo $template['zip']; ?>" data-uid="<?php echo $template['uid']; ?>"><i class="eg-icon-download"></i><?php echo __('Install Slider Pack', 'revslider'); ?></div>
                    <?php
                }
            } else {
                ?>
                <div class="dontadd_template_slider_item"><i class="icon-not-registered"></i><?php echo __('Requirements not met', 'revslider'); ?></div>
                <?php
            }
            ?>
            <span class="tp-clearfix" style="margin-bottom:5px"></span>
	...
	public function write_import_template_markup_slide($template){
        ...
        <div class="template_thumb_more">
            ...
            <span class="ttm_space"></span>
            <span class="ttm_label_direct"><span class="ttm_label_half"><?php echo __('Installed Vers.', 'revslider'); ?></span><span class="ttm_label_half"><?php echo __('Available Vers.', 'revslider'); ?></span></span>
            <span class="ttm_label_half ttm_insalled"><span class="ttm_label_half ttm_available"><?php echo $template['version'];?></span>
            <span class="ttm_space"></span>
            <?php
            if($deny == '' && $allow_install == true){
                ?>
                <div class="install_template_slide<?php echo $deny; ?>" data-slidenumber="<?php echo $template['number']; ?>" data-zipname="<?php echo $template['zip']; ?>" data-uid="<?php echo $template['uid']; ?>"><i class="eg-icon-download"></i><?php echo __('Install Slider', 'revslider'); ?></div>
                <?php
            } else {
                ?>
                <div class="dontadd_template_slider_item"><i class="icon-not-registered"></i><?php echo __('Requirements not met', 'revslider'); ?></div>
        ...
        if (isset($template["user_template"])) {
            ...
            <div class="template_thumb_more">
                ...
                if ($allow_install !== false) {
                    if($slider_id !== false){
                        ?>
                        <div class="install_template_slider" data-zipname="<?php echo $template['zip']; ?>" data-uid="<?php echo $template['uid']; ?>"><i class="eg-icon-download"></i><?php echo __('Re-Install Slider', 'revslider'); ?></div>
                        <span class="tp-clearfix" style="margin-bottom:5px"></span>
                        <?php
                        if(isset($template['package']) && $template['package'] !== ''){
