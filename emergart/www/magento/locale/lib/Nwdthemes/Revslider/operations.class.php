...
class RevSliderOperations extends RevSliderElementsBase{
	...
	public static function getStaticCss(){
		if ( Mage::helper('nwdrevslider/framework')->is_multisite() ){
...
ob_end_clean();
		...
		$search = array($cont_url, $cont_url_no_www, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL);
		...
		if($export_real){ //only include if real export
			...
			if(!$usepcl){
				...
				$zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/font-awesome/css/font-awesome.min.css', 'fonts/font-awesome/css/font-awesome.min.css');
				...
				$pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/fonts/font-awesome/css/font-awesome.min.css', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/');
	...
	public function checkPurchaseVerification($data){
		...
		if($version_info == 'valid'){
            ...
            //Mage::helper('nwdrevslider/framework')->update_option('revslider-email', $data['email']);
	...
	public static function get_slider_speed($sliderID){
		//$data = Mage::helper('nwdrevslider/images')->wp_get_attachment_metadata($cur_img_id);
