...
tpLayerTimelinesRev = new function(){
	var t = this,
		u = new Object(),
		sortMode = "time",
		__ctime,
	...
	t.init = function() {
		...
		var createListOfTrans = function() {
			...
			for(var key in choosen_slide_transition) if (choosen_slide_transition.hasOwnProperty(key)) {
				...
				c.append('<li value="'+choosen_slide_transition[key]+'"'+data_string+' class="justaddedtrans draggable-trans-element">'+jQuery('input[name="slide_transition[]"][value="'+choosen_slide_transition[key]+'"]').data('name')+'<i class="remove-trans-from-list eg-icon-cancel"></i></li>');
		...
		jQuery('input[name="slide_transition[]"]').on("change",function() {
			if (jQuery(this).is(":checked")) {
				...
				jQuery('.slide-trans-cur-ul').append('<li value="'+jQuery(this).val()+'"'+data_string+' class="justaddedtrans draggable-trans-element">'+jQuery(this).data('name')+'<i class="remove-trans-from-list eg-icon-cancel"></i></li>')
	...
	*/
	...
	var updateZIndexByOrder = function(){
		var l = u.getLayers()		
		for(var key in u.getLayers()) if (u.getLayers().hasOwnProperty(key)) {
			var layer = l[key];
