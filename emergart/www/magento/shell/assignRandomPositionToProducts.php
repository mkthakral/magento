...
class Mage_Product_Random_Listing extends Mage_Shell_Abstract
{
	...
	public $paintingCategoryId = 3;
	public $drawingCategoryId = 4;
	public $photographyCategoryId = 5;
	public $sculptureCategoryId = 6;
   ...
   /**
    ...
    public function run()
    {
	$this->updateProductPositions($this->paintingCategoryId);
	$this->updateProductPositions($this->drawingCategoryId);
	$this->updateProductPositions($this->photographyCategoryId);
	$this->updateProductPositions($this->sculptureCategoryId);
    }
