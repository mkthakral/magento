 ...
 */
class Nwdthemes_Revslider_Block_Adminhtml_Cms_Wysiwyg_Images_Content_Uploader extends Mage_Uploader_Block_Multiple
{
    /**
    ...
    public function __construct()
    {
        ...
        $allowed = Mage::getModel('nwdrevslider/images_storage')->getAllowedExtensions($type);
