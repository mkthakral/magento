...
class RevSliderObjectLibrary {
    ...
    public function _get_list($force = false){
        ...
        if(time() - $last_check > 1296000 || $force == true){ //30 days
            ...
            $count = 0;
            do {
                $url = $this->_rslb->get_url('library');
                $request = Mage::helper('nwdrevslider/framework')->wp_remote_post($url . '/' . $this->library_list, array(
                    'body' => $rattr
                ));
            ...
            if(!file_exists($file) || isset($temp['push_image'])){
                ...
                if($curl !== false){
                    ...
                    if($validated == 'false' && $type != 'thumb'){
                        ...
                        do {
                            $url = $this->_rslb->get_url('library');
                            $image_data = Mage::helper('nwdrevslider/framework')->wp_remote_post($url . '/' . $this->library_download, array(
                                'body' => array(
                                    'code' => urlencode($code),
                            ...
                            $response_code = Mage::helper('nwdrevslider/framework')->wp_remote_retrieve_response_code($image_data);
                            if ($response_code == 200) {
                                $done = true;
                            } else {
                                $this->_rslb->move_server_list();
    ...
    public function write_markup(){
        ...
        <div id="dialog_addobj" class="dialog-addobj" title="<?php echo Mage::helper('nwdrevslider')->__("Add Object Layer"); ?>" style="display:none">
                ...
                <div id="addobj-list-of-items">
                    <div id="addobj-dialog-header">
                        <div class="object_library_search_wrapper">
                            <input type="text" id="obj_library_search" placeholder="<?php echo Mage::helper('nwdrevslider')->__("Search for Objects..."); ?>" /><span id="obj_library_search_trigger"><i class="eg-icon-search"></i></span>
                        </div>
                        <div id="object_library_type_list_new">
                            <span id="obj_lib_main_cat_filt_all" data-value="all" class="obj_library_cats_filter"><?php echo Mage::helper('nwdrevslider')->__("ALL"); ?></span>
                            <span id="obj_lib_main_cat_filt_allimages" data-value="allimages" class="obj_library_cats_filter all_img_cat"><?php echo Mage::helper('nwdrevslider')->__("ALL IMAGES"); ?></span>
                            <span id="obj_lib_main_cat_filt_svg" data-value="svg" class="obj_library_cats_filter svg_cat"><?php echo Mage::helper('nwdrevslider')->__("SVG"); ?></span>
                            <span id="obj_lib_main_cat_filt_icon" data-value="icon" class="obj_library_cats_filter fonticon_cat"><?php echo Mage::helper('nwdrevslider')->__("ICON"); ?></span>
                            <span id="obj_lib_main_cat_filt_image" data-value="image" class="obj_library_cats_filter png_cat"><?php echo Mage::helper('nwdrevslider')->__("PNG"); ?></span>
                            <span id="obj_lib_main_cat_filt_bgimage" data-value="bgimage" class="obj_library_cats_filter jpg_cat"><?php echo Mage::helper('nwdrevslider')->__("JPG"); ?></span>
                        </div>
                        <div id="up-lic-ob-lib">
                            <div id="licence_obect_library"><i class="fa-icon-copyright"></i><?php echo Mage::helper('nwdrevslider')->__("License Info"); ?></div>
                            <div id="update_obect_library"><i class="eg-icon-arrows-ccw"></i><?php echo Mage::helper('nwdrevslider')->__("Update Object Library"); ?></div>
                        </div>
                        <div id="object-tag-list" class="object-tag-list"><span id="obj_library_cats_favorite" class="obj_library_cats" data-tag="favorite" data-image="true" data-bgimages="true" data-svg="true"><i class="fa-icon-star-o" style="margin-right: 5px;"></i><?php echo Mage::helper('nwdrevslider')->__("Favorite"); ?></span><span id="obj_library_cats_allico" class="obj_library_cats" data-tag="allicon" data-icon="true" data-bgimages="false" data-svg="false"><i class="fa-icon-folder-o" style="margin-right: 5px;"></i><?php echo Mage::helper('nwdrevslider')->__("All Icons"); ?></span><span id="obj_library_cats_allpng" class="obj_library_cats" data-tag="allpng" data-image="true" data-bgimages="false" data-svg="false"><i class="fa-icon-folder-o" style="margin-right: 5px;"></i><?php echo Mage::helper('nwdrevslider')->__("All PNG"); ?></span><span id="obj_library_cats_alljpg" class="obj_library_cats" data-tag="alljpg" data-image="false" data-bgimages="true" data-svg="false"><i class="fa-icon-folder-o" style="margin-right: 5px;"></i><?php echo Mage::helper('nwdrevslider')->__("All JPG"); ?></span><span id="obj_library_cats_allsvg" class="obj_library_cats" data-tag="allsvg" data-image="false" data-bgimages="false" data-svg="true"><i class="fa-icon-folder-o" style="margin-right: 5px;"></i><?php echo Mage::helper('nwdrevslider')->__("All SVG"); ?></span></div>
                    </div>
            ...
            <div id="bg-vs-layer-wrapper">
                <span id="add_objimage_as_layer"><?php echo Mage::helper('nwdrevslider')->__("As Layer"); ?></span><span class="addthisasbg" id="obj-layer-bg-switcher"></span><span id="add_objimage_as_slidebg"><?php echo Mage::helper('nwdrevslider')->__("As Slide BG"); ?></span>
            </div>
