...
class TPColorpicker {
    ...
    public function __construct(){
        Mage::helper('nwdrevslider/framework')->add_filter(AJAX_ACTION, array($this, 'init_ajax'), 10, 6);
    }
    ...
    public static function convert($color, $opacity){
        ...
        if(!is_bool($opacity) && "".$opacity === "0"){
            ...
            if(strpos($color,'rgba') === false && strpos($color,'#') !== false) {
                ...
                return isset($color[0]) ? $color[0] : false;
            }
        }
        ...
        // Fix for case when it is just 6 digit number without # char, eg. 083457
    ...
    public static function save_color_presets($presets){
        ...
        Mage::helper('nwdrevslider/framework')->update_option('tp_colorpicker_presets', $presets);
    ...
    public static function get_color_presets(){
        ...
        return Mage::helper('nwdrevslider/framework')->get_option('tp_colorpicker_presets', array());
