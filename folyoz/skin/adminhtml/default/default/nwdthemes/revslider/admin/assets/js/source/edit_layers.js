...
// DATE: 28-04-2015
    UniteLayersRev = new function(){
        ...
        t.attributegroups = [
            ...
            { id:"1",icon:"play", groupname:"Start Animation", keys:["text_c_start", "bg_c_start", "use_text_c_start", "use_bg_c_start", "x_rotate_start","x_rotate_start_reverse","x_start","x_start_reverse","y_rotate_start","y_rotate_start_reverse","y_start","y_start_reverse","z_rotate_start","z_rotate_start_reverse","z_start"]},
            { id:"2",icon:"play", groupname:"End Animation", keys:["text_c_end", "bg_c_end", "use_text_c_end", "use_bg_c_end", "x_end","x_end_reverse","x_origin_end","x_rotate_end","x_rotate_end_reverse","y_end","y_end_reverse","y_rotate_end","y_rotate_end_reverse","z_end","z_rotate_end","z_rotate_end_reverse"]},
            ...
            { id:"13",icon:"star", groupname:"SVG Style", keys:["svg.svgstroke-color","svg.svgstroke-dasharray","svg.svgstroke-dashoffset","svg.svgstroke-width","svg.svgstroke-hover-color","svg.svgstroke-hover-dasharray","svg.svgstroke-hover-dashoffset","svg.svgstroke-hover-width"]},
            ...
            { id:"16",icon:"droplet", groupname:"Styling Text", keys:["deformation.font-family","deformation.font-style","deformation.opacity","deformation.text-align","deformation.vertical-align","deformation.display","deformation.text-decoration"]},
            ...
            { id:"20",icon:"droplet", groupname:"Styling Border", keys:["deformation.border-color","deformation.border-radius.0","deformation.border-radius.1","deformation.border-radius.2","deformation.border-radius.3","deformation.border-style","deformation.border-width"]},
            ...
            { id:"23",icon:"droplet", groupname:"Styling Hover Text", keys:["deformation-hover.color","deformation-hover.font-family","deformation-hover.font-style","deformation-hover.opacity","deformation-hover.text-align","deformation-hover.vertical-align","deformation-hover.text-decoration"]},
            ...
            { id:"26",icon:"droplet", groupname:"Styling Hover Background", keys:["deformation-hover.background-color"]},
            { id:"27",icon:"droplet", groupname:"Styling Hover Border", keys:["deformation-hover.border-color","deformation-hover.border-radius.0","deformation-hover.border-radius.1","deformation-hover.border-radius.2","deformation-hover.border-radius.3","deformation-hover.border-style","deformation-hover.border-width"]},
        ...
        t.init = function(slideTime){
            ...
            jQuery('#layer_animation, #layer_endanimation').change(function(){
                ...
                t.checkAvailableAnimationFields();
                    ...
                    buttons:{
                        'Save':function(){
                            ...
                            for(var key in initLayerAnims) if (initLayerAnims.hasOwnProperty(key)) {
                                if(initLayerAnims[key]['handle'] == new_handle){
                                    is_new_handle_existing = true;
                                    new_handle = (what == 'start') ? 'customin' : 'customout';
                                    new_handle += '-'+initLayerAnims[key]['id'];
                                    break;
                                }
                            }
                            ...
                            updateAnimInDb(new_handle, anim, is_new);
                            jQuery(this).dialog('close');
                        },
                        'Cancel':function(){
                            jQuery(this).dialog('close');
        ...
        var initButtons = function(){
            ...
            t.remove_import_layer_actions = function(layer){
                var attr = ['tooltip_event', 'action', 'image_link', 'link_follow' , 'link_open_in', 'jump_to_slide', 'scrollunder_offset', 'actioncallback', 'layer_target', 'action_delay', 'link_type', 'toggle_layer_type', 'toggle_class'];
            ...
            var addSpecialButton = function(btn) {
                ...
                data['deformation']['background-color'] = btn.css('backgroundColor');
                data['deformation']['border-color'] = btn.css('borderTopColor');
            ...
            jQuery('body').on('click', '.addbutton-examples-wrapper span.rev-control-btn', function(){
                ...
                data['static_styles']['line-height'] = jQuery(this).css('line-height');
                data['static_styles']['font-weight'] = jQuery(this).css('font-weight');
                data['static_styles']['color'] = jQuery(this).css('color');
        ...
        var createNewAnimObj = function(what){
            ...
            if(what == 'start'){
                ...
                customAnim['use_text_c'] = jQuery('#use_text_color_start')[0].checked;
                customAnim['use_bg_c'] = jQuery('#use_bg_color_start')[0].checked;
                ...
                //customAnim['letterspacing'] = jQuery('input[name="letterspacing_start"]').val();
                customAnim['grayscalefilter'] = jQuery('input[name="grayscalefilter_start"]').val();
                customAnim['brightnessfilter'] = jQuery('input[name="brightnessfilter_start"]').val();
                customAnim['mask_x'] = jQuery('input[name="mask_anim_xstart"]').val();
                customAnim['mask_y'] = jQuery('input[name="mask_anim_ystart"]').val();

                customAnim['text_c'] = jQuery('input[name="text_color_start"]').val();
                customAnim['bg_c'] = jQuery('input[name="bg_color_start"]').val();
                ...
                customAnim['split_direction'] = jQuery('select[name="layer_split_direction"] option:selected').val();
                customAnim['splitdelay'] = jQuery('input[name="layer_splitdelay"]').val();

                customAnim['sfx_effect'] = jQuery('#sfx_in_effect').val();
                ...
                customAnim['use_text_c'] = jQuery('#use_text_color_end')[0].checked;
                customAnim['use_bg_c'] = jQuery('#use_bg_color_end')[0].checked;
                customAnim['text_c'] = jQuery('input[name="text_color_end"]').val();
                customAnim['bg_c'] = jQuery('input[name="bg_color_end"]').val();
                ...
                customAnim['split_direction'] = jQuery('#layer_endsplit_direction option:selected').val();
                customAnim['splitdelay'] = jQuery('#layer_endsplitdelay').val();

                customAnim['sfx_effect'] = jQuery('#sfx_out_effect').val();
        ...
        var setNewAnimFromObj = function(what, obj_v){
            ...
            if(what == 'start'){
                ...
                if(obj_v['brightnessfilter'] !== undefined) { jQuery('input[name="brightnessfilter_start"]').val(obj_v['brightnessfilter']); }else{ jQuery('input[name="brightnessfilter_start"]').val(100); }
                //if(obj_v['letterspacing'] !== undefined) { jQuery('input[name="letterspacing_start"]').val(obj_v['letterspacing']); }else{ jQuery('input[name="letterspacing_start"]').val(0); }
                ...
                if(obj_v['use_text_c'] !== undefined && (obj_v['use_text_c'] == 'true' || obj_v['use_text_c'] == true)) { jQuery('#use_text_color_start').attr('checked', true); }else{ jQuery('#use_text_color_start').attr('checked', false); }
                if(obj_v['use_bg_c'] !== undefined && (obj_v['use_bg_c'] == 'true' || obj_v['use_bg_c'] == true)) { jQuery('#use_bg_color_start').attr('checked', true); }else{ jQuery('#use_bg_color_start').attr('checked', false); }
                if(obj_v['text_c'] !== undefined) { jQuery('input[name="text_color_start"]').val(obj_v['text_c']); }else{ jQuery('input[name="text_color_start"]').val("transparent"); }
                if(obj_v['bg_c'] !== undefined) { jQuery('input[name="bg_color_start"]').val(obj_v['bg_c']); }else{ jQuery('input[name="bg_color_start"]').val("transparent"); }
                ...
                if(obj_v['sfx_color_in'] !== undefined) { jQuery('input[name="sfx_color_in"]').val(obj_v['sfx_color_in']); }
                if(obj_v['split'] !== undefined) { jQuery('select[name="layer_split"] option[value="'+obj_v['split']+'"]').attr('selected', 'selected'); }
                if(obj_v['split_direction'] !== undefined) { jQuery('select[name="layer_split_direction"] option[value="'+obj_v['split_direction']+'"]').attr('selected', 'selected'); }
                ...
                if(obj_v['use_text_c'] !== undefined && (obj_v['use_text_c'] == 'true' || obj_v['use_text_c'] == true)) { jQuery('#use_text_color_end').attr('checked', true); }else{ jQuery('#use_text_color_end').attr('checked', false); }
                if(obj_v['use_bg_c'] !== undefined && (obj_v['use_bg_c'] == 'true' || obj_v['use_bg_c'] == true)) { jQuery('#use_bg_color_end').attr('checked', true); }else{ jQuery('#use_bg_color_end').attr('checked', false); }
                if(obj_v['text_c'] !== undefined) { jQuery('input[name="text_color_end"]').val(obj_v['text_c']); }else{ jQuery('input[name="text_color_end"]').val("transparent"); }
                if(obj_v['bg_c'] !== undefined) { jQuery('input[name="bg_color_end"]').val(obj_v['bg_c']); }else{ jQuery('input[name="bg_color_end"]').val("transparent"); }
                ...
                if(obj_v['sfxcolor'] !== undefined) { jQuery('input[name="sfx_color_end"]').val(obj_v['sfxcolor']); }
                if(obj_v['split'] !== undefined) { jQuery('#layer_endsplit option[value="'+obj_v['split']+'"]').attr('selected', 'selected'); }
                if(obj_v['split_direction'] !== undefined) { jQuery('#layer_endsplit_direction option[value="'+obj_v['split_direction']+'"]').attr('selected', 'selected'); }
            ...
            RevSliderSettings.onoffStatus(jQuery('#masking-end'));
            RevSliderSettings.onoffStatus(jQuery('#use_text_color_start'));
            RevSliderSettings.onoffStatus(jQuery('#use_bg_color_start'));
            RevSliderSettings.onoffStatus(jQuery('#use_text_color_end'));
            RevSliderSettings.onoffStatus(jQuery('#use_bg_color_end'));
                ...
                UniteAdminRev.ajaxRequest("update_custom_anim",animObj,function(response){
                    ...
                    for(var key in t.arrLayers) if (t.arrLayers.hasOwnProperty(key)) {
                        ...
                        if(t.arrLayers[key].frames.frame_999.animation == 'customout-'+raw_handle){
                            ...
                            t.arrLayers[key].use_text_c_end = animObj['params']['use_text_c'];
                            t.arrLayers[key].use_bg_c_end = animObj['params']['use_bg_c'];
                            t.arrLayers[key].text_c_end = animObj['params']['text_c'];
                            t.arrLayers[key].bg_c_end = animObj['params']['bg_c'];
                            ...
                            //t.arrLayers[key].letterspacing_start = animObj['params']['letterspacing'];
                            t.arrLayers[key].grayscalefilter_start = animObj['params']['grayscalefilter'];
                            t.arrLayers[key].brightnessfilter_start = animObj['params']['brightnessfilter'];
                            ...
                            t.arrLayers[key].use_text_c_start = animObj['params']['use_text_c'];
                            t.arrLayers[key].use_bg_c_start = animObj['params']['use_bg_c'];

                            t.arrLayers[key].text_c_start = animObj['params']['text_c'];
                            t.arrLayers[key].bg_c_start = animObj['params']['bg_c'];
        ...
        t.makeLayerHtml = function(serial,objLayer,isDemo){
            ...
            switch(type){
                case "image":
                    var addStyle = '';
                    html += '<img src="'+objLayer.image_url+'" alt="'+objLayer.alt+'" style="'+addStyle+'"/>';
                    break;
                default:
                case "text":
                case "button":
                    ...
                    if(foundstyles.params['color'] !== undefined){
                        if(exclude !== undefined && devices !== undefined){
                            if(jQuery.inArray('color', exclude) !== -1){
                                //set for specific devices now
                                layer['static_styles'] = t.setVal(layer['static_styles'], 'color', foundstyles.params['color'], false, devices);
                            }
                            if(jQuery.inArray(layout, devices) !== -1){
                                jQuery('#layer_color_s').val(foundstyles.params['color']).tpColorPicker("refresh");
        ...
        ///////////////////////////
        jQuery(document).on('addLayer',function(event,data) {
            if (data!==undefined) {
                addLayer(data.objLayer, data.isInit, data.isDemo, data.skipScroller);
            }
        });
        ...
        var addLayer = function(objLayer, isInit, isDemo, skipScroller){
            ...
            objLayer.layer_action.link_follow = objLayer.layer_action.link_follow !== undefined ? objLayer.layer_action.link_follow : [];
            ...
            //set image link open in
            objLayer.link_follow = (objLayer.link_follow !== undefined) ? objLayer.link_follow : "follow";
            ...
            if (objLayer.time!==undefined) {
                objLayer.frames.frame_0 = {time:Number(objLayer.time), delay:0, split:objLayer.split, split_direction:"forward", split_extratime: 0, splitdelay:objLayer.splitdelay, speed:objLayer.speed,animation:objLayer.animation, easing:objLayer.easing };
            ...
            if (objLayer.endtime!==undefined) {
                objLayer.frames.frame_999 = {time:objLayer.endtime, delay:0,split:objLayer.endsplit, split_extratime:0, split_direction:"forward", splitdelay:objLayer.endsplitdelay, speed:objLayer.endspeed!=undefined ? objLayer.endspeed : initSpeed, animation:objLayer.endanimation, easing:objLayer.endeasing};
            ...
            objLayer.frames.frame_0.text_c = objLayer.frames.frame_0.text_c !== undefined ? objLayer.frames.frame_0.text_c : "transparent";
            objLayer.frames.frame_0.bg_c = objLayer.frames.frame_0.bg_c !== undefined ? objLayer.frames.frame_0.bg_c : "transparent";
            objLayer.frames.frame_0.use_text_c =  objLayer.frames.frame_0.use_text_c===undefined ? false : objLayer.frames.frame_0.use_text_c;
            objLayer.frames.frame_0.use_bg_c =  objLayer.frames.frame_0.use_bg_c===undefined ? false : objLayer.frames.frame_0.use_bg_c;
            ...
            objLayer.frames.frame_0.split_direction =  objLayer.frames.frame_0.split_direction===undefined ? "forward" : objLayer.frames.frame_0.split_direction;
            ...
            objLayer.frames.frame_0.sfxcolor =  objLayer.frames.frame_0.sfxcolor===undefined ? '#ffffff' : objLayer.frames.frame_0.sfxcolor;
            ...
            objLayer.frames.frame_999.split_direction =  objLayer.frames.frame_999.split_direction===undefined ? "forward" : objLayer.frames.frame_999.split_direction
            ...
            objLayer.frames.frame_999.sfxcolor =  objLayer.frames.frame_999.sfxcolor===undefined ? '#ffffff' : objLayer.frames.frame_999.sfxcolor;
            objLayer.frames.frame_999.use_text_c =  objLayer.frames.frame_0.use_text_c===undefined ? false : objLayer.frames.frame_0.use_text_c;
            objLayer.frames.frame_999.use_bg_c =  objLayer.frames.frame_0.use_bg_c===undefined ? false : objLayer.frames.frame_0.use_bg_c;
            objLayer.frames.frame_999.text_c = objLayer.frames.frame_999.text_c !== undefined ? objLayer.frames.frame_999.text_c : "transparent";
            objLayer.frames.frame_999.bg_c = objLayer.frames.frame_999.bg_c !== undefined ? objLayer.frames.frame_999.bg_c : "transparent";
            ...
            if (objLayer.deformation!==undefined) {
                // CONVERT STATIC COLORS
                if (objLayer.deformation["color-transparency"]!==undefined) {
                    for (var $c in objLayer['static_styles']['color']) {
                        if (objLayer['static_styles']['color'][$c]!==undefined && objLayer['static_styles']['color'][$c].length>0)
                            objLayer['static_styles']['color'][$c] = window.RevColor.convert(objLayer['static_styles']['color'][$c],objLayer.deformation["color-transparency"]*100);
                    }
                    delete objLayer.deformation["color-transparency"];
                }
                // CONVERT BACKGROUND COLOR OF LAYERS
                if (objLayer["deformation"]["background-transparency"]!==undefined && objLayer["deformation"]["background-color"]!==undefined && objLayer["deformation"]["background-color"].length>0) {
                    objLayer["deformation"]["background-color"] = window.RevColor.convert(objLayer["deformation"]["background-color"],objLayer["deformation"]["background-transparency"]*100);
                    delete objLayer['deformation']['background-transparency'];
                }

                // CONVERT BORDER COLOR OF LAYERS
                if (objLayer["deformation"]["border-transparency"]!==undefined && objLayer["deformation"]["border-color"]!==undefined && objLayer["deformation"]["border-color"].length>0) {
                    objLayer["deformation"]["border-color"] = window.RevColor.convert(objLayer["deformation"]["border-color"],objLayer["deformation"]["border-transparency"]*100);
                    delete objLayer["deformation"]["border-transparency"];
                }
            ...
            if (objLayer["deformation-hover"]!==undefined) {
                // CONVERT HOVER COLORS
                if (objLayer["deformation-hover"]["color-transparency"]!==undefined && objLayer["deformation-hover"]["color"]!==undefined && objLayer["deformation-hover"]["color"].length>0) {
                    objLayer["deformation-hover"]["color"] = window.RevColor.convert(objLayer["deformation-hover"]["color"],objLayer["deformation-hover"]["color-transparency"]*100);
                    delete objLayer["deformation-hover"]["color-transparency"];
                }

                // CONVERT HOVER BACKGROUND COLOR OF LAYERS
                if (objLayer["deformation-hover"]["background-transparency"]!==undefined && objLayer["deformation-hover"]["background-color"]!==undefined && objLayer["deformation-hover"]["background-color"].length>0) {
                    objLayer["deformation-hover"]["background-color"] = window.RevColor.convert(objLayer["deformation-hover"]["background-color"],objLayer["deformation-hover"]["background-transparency"]*100);
                    delete objLayer["deformation-hover"]["background-transparency"];
                }

                // CONVERT HOVER BORDER COLOR OF LAYERS
                if (objLayer["deformation-hover"]["border-transparency"]!==undefined && objLayer["deformation-hover"]["border-color"]!==undefined && objLayer["deformation-hover"]["border-color"].length>0) {
                    objLayer["deformation-hover"]["border-color"] = window.RevColor.convert(objLayer["deformation-hover"]["border-color"],objLayer["deformation-hover"]["border-transparency"]*100);
                    delete objLayer["deformation-hover"]["border-transparency"];
                }

            }

            if (objLayer.svg!==undefined) {
                // CONVERT SVG COLOR OF LAYERS
                if (objLayer.svg["svgstroke-transparency"]!==undefined && objLayer.svg["svgstroke-color"]!==undefined && objLayer.svg["svgstroke-color"].length>0) {
                    objLayer.svg["svgstroke-color"] = window.RevColor.convert(objLayer.svg["svgstroke-color"],objLayer.svg["svgstroke-transparency"]*100);
                    delete objLayer.svg["svgstroke-transparency"];
                }

                // CONVERT HOVER SVG COLOR OF LAYERS
                if (objLayer.svg["svgstroke-hover-transparency"]!==undefined && objLayer.svg["svgstroke-hover-color"]!==undefined && objLayer.svg["svgstroke-hover-color"].length>0) {
                    objLayer.svg["svgstroke-hover-color"] = window.RevColor.convert(objLayer.svg["svgstroke-hover-color"],objLayer.svg["svgstroke-hover-transparency"]*100);
                    delete objLayer.svg["svgstroke-hover-transparency"];
                }
            }
            ...
            /*if(objLayer.letterspacing_start == undefined){
             if(isInit == false){
             objLayer.letterspacing_start = "0";
             }else{
             objLayer.letterspacing_start = "inherit";
             }
             }

             if(objLayer.letterspacing_end == undefined){
             if(isInit == false){
             objLayer.letterspacing_end = "0";
             }else{
             objLayer.letterspacing_end = "inherit";
             }
             }*/
            ...
            if(objLayer.brightnessfilter_start == undefined){
                if(isInit == false){
                    objLayer.brightnessfilter_start = "100";
                }else{
                    objLayer.brightnessfilter_start = "100";
                }
            }

            if(objLayer.brightnessfilter_end == undefined){
                if(isInit == false){
                    objLayer.brightnessfilter_end = "100";
                }else{
                    objLayer.brightnessfilter_end = "100";
                }
            }
            ...
            if (objLayer['deformation']['brightnessfilter'] == undefined) objLayer['deformation']['brightnessfilter'] = 100;
            ...
            if (objLayer['deformation-hover']['brightnessfilter'] == undefined) objLayer['deformation-hover']['brightnessfilter'] = 100;
		...
		if(objLayer['deformation-hover']['pointer_events'] == undefined)
            ...
            jQuery.each(t.addon_callbacks, function(i,callback_element) {
                ...
                if (env === "add_layer_to_stage" && env_sub=="end")  {
                    objLayer = callback(objLayer);
                }
            });
        ...
        t.updateLayerFromFields_Core = function(){
            ...
            objUpdate.frames["frame_0"].use_text_c = document.getElementById("use_text_color_start").checked;
            objUpdate.frames["frame_0"].use_bg_c = document.getElementById("use_bg_color_start").checked;
            objUpdate.frames["frame_0"].text_c = document.getElementById("text_color_start").value;
            objUpdate.frames["frame_0"].bg_c = document.getElementById("bg_color_start").value;
            ...
            objUpdate.frames["frame_0"].sfx_effect = document.getElementById("sfx_in_effect").value;
            objUpdate.frames["frame_0"].sfxcolor = document.getElementById("sfx_color_start").value;
            objUpdate.frames["frame_0"].split = document.getElementById("layer_split").value;
            objUpdate.frames["frame_0"].split_direction = document.getElementById("layer_split_direction").value;
            ...
            objUpdate.frames["frame_999"].split_direction = document.getElementById("layer_endsplit_direction").value;
            ...
            objUpdate.frames["frame_999"].sfxcolor = document.getElementById("sfx_color_end").value;
            objUpdate.frames["frame_999"].easing = document.getElementById("layer_endeasing").value;
            objUpdate.frames["frame_999"].sfx_effect = document.getElementById("sfx_out_effect").value;
            objUpdate.frames["frame_999"].use_text_c= document.getElementById("use_text_color_end").checked;
            objUpdate.frames["frame_999"].use_bg_c = document.getElementById("use_bg_color_end").checked;
            objUpdate.frames["frame_999"].text_c = document.getElementById("text_color_end").value;
            objUpdate.frames["frame_999"].bg_c = document.getElementById("bg_color_end").value;
            ...
            //objUpdate.letterspacing_start = document.getElementById("letterspacing_start").value;
            //objUpdate.letterspacing_end = document.getElementById("letterspacing_end").value;
            ...
            objUpdate.brightnessfilter_start = document.getElementById("brightnessfilter_start").value;
            objUpdate.brightnessfilter_end = document.getElementById("brightnessfilter_end").value;
            ...
            objUpdate['deformation']['brightnessfilter'] =  document.getElementById('brightnessfilter_idle').value;
		...
		objUpdate['deformation-hover']['pointer_events'] = jQuery('#pointer_events option:selected').val();
            ...
            objUpdate['layer_action'].link_follow = [];
            jQuery('select[name="layer_link_follow[]"] option:selected').each(function(){
                objUpdate['layer_action'].link_follow.push(jQuery(this).val());
            });
        ...
        var updateSubStyleParameters = function(objLayer, reset_full) {
            ...
            if(objLayer.deformation != undefined && styles !== undefined){
                ...
                //  VERTICAL-ALIGN
                if (nix(objLayer['deformation']['vertical-align']) || reset)
                    objLayer['deformation']['vertical-align'] = !nix(styles["vertical-align"]) ? styles["vertical-align"] : "top";
                ...
                if (nix(objLayer['deformation']['background-color']) || reset) {
                    objLayer['deformation']['background-color'] = !nix(styles['background-color']) ? styles['background-color'] : "transparent";;
                }

                // BORDER COLOR
                if (nix(objLayer['deformation']['border-color']) || reset)
                    objLayer['deformation']['border-color'] = !nix(styles['border-color']) ? styles['border-color'] : "transparent";
                ...
                if (nix(objLayer['deformation']['brightnessfilter']) || reset) objLayer['deformation']['brightnessfilter'] =  !nix(styles['brightnessfilter']) ?  styles['brightnessfilter'] : 100;
            ...
            if (objLayer['svg']!=undefined && svgstyles!=undefined) {
                ...
                if (nix(objLayer['svg']['svgstroke-color']) || reset)
                    objLayer['svg']['svgstroke-color'] = !nix(svgstyles['svgstroke-color']) ? svgstyles['svgstroke-color'] : "transparent";
                ...
                if (nix(objLayer['svg']['svgstroke-hover-color']) || reset)
                    objLayer['svg']['svgstroke-hover-color'] = !nix(svgstyles['svgstroke-hover-color']) ? svgstyles['svgstroke-hover-color'] : "transparent";
            ...
            if(objLayer.deformation != undefined){
                ...
                jQuery('#css_background-color').val(objLayer['deformation']['background-color']).tpColorPicker("refresh");

                jQuery('#css_border-color-show').val(objLayer['deformation']['border-color']).tpColorPicker("refresh");
                ...
                jQuery('#brightnessfilter_idle').val(objLayer['deformation']['brightnessfilter']);
                ...
                jQuery('#brightnessfilter_hover').val(objLayer['deformation-hover']['brightnessfilter']);
			...
			if (nix(objLayer['deformation-hover']['pointer_events']) || reset)
                ...
                if (nix(objLayer['deformation-hover']['brightnessfilter']) || reset) objLayer['deformation-hover']['brightnessfilter'] =  !nix(hover_styles['brightnessfilter']) ?  hover_styles['brightnessfilter'] : 100;
                ...
                if(objLayer['deformation-hover'] != undefined){
                    jQuery('#hover_layer_color_s').val(objLayer['deformation-hover']['color']).tpColorPicker("refresh");
                    jQuery('#hover_css_text-decoration option[value="'+objLayer['deformation-hover']['text-decoration']+'"]').attr('selected', true);
                    jQuery('#hover_css_background-color').val(objLayer['deformation-hover']['background-color']).tpColorPicker("refresh");
        ...
        t.updateLayerFormFields = function(serial){
            ...
            if(objLayer.frames["frame_0"].use_text_c == "true" || objLayer.frames["frame_0"].use_text_c == true) {
                jQuery('#use_text_color_start').attr("checked", true);
                jQuery('.use_text_color_wrap_start').show();
            }
            else {
                jQuery('#use_text_color_start').attr("checked", false);
                jQuery('.use_text_color_wrap_start').hide();
            }

            if(objLayer.frames["frame_0"].use_bg_c == "true" || objLayer.frames["frame_0"].use_bg_c == true) {
                jQuery('#use_bg_color_start').attr("checked", true);
                jQuery('.use_bg_color_wrap_start').show();
            }
            else {
                jQuery('#use_bg_color_start').attr("checked", false);
                jQuery('.use_bg_color_wrap_start').hide();
            }

            if(objLayer.frames["frame_999"].use_text_c == "true" || objLayer.frames["frame_999"].use_text_c == true) {
                jQuery('#use_text_color_end').attr("checked", true);
                jQuery('.use_text_color_wrap_end').show();
            }
            else {
                jQuery('#use_text_color_end').attr("checked", false);
                jQuery('.use_text_color_wrap_end').hide();
            }

            if(objLayer.frames["frame_999"].use_bg_c == "true" || objLayer.frames["frame_999"].use_bg_c == true) {
                jQuery('#use_bg_color_end').attr("checked", true);
                jQuery('.use_bg_color_wrap_end').show();
            }
            else {
                jQuery('#use_bg_color_end').attr("checked", false);
            ...
            jQuery("#text_color_start").val(objLayer.frames["frame_0"].text_c).tpColorPicker("refresh");
            jQuery("#bg_color_start").val(objLayer.frames["frame_0"].bg_c).tpColorPicker("refresh");
            jQuery("#text_color_end").val(objLayer.frames["frame_999"].text_c).tpColorPicker("refresh");
            jQuery("#bg_color_end").val(objLayer.frames["frame_999"].bg_c).tpColorPicker("refresh");
            ...
            jQuery("#sfx_in_effect").val(objLayer.frames["frame_0"].sfx_effect);
            jQuery("#sfx_out_effect").val(objLayer.frames["frame_999"].sfx_effect);

            jQuery("#layer_split").val(objLayer.frames["frame_0"].split);
            jQuery("#layer_split_direction").val(objLayer.frames["frame_0"].split_direction);
            jQuery("#layer_endsplit").val(objLayer.frames["frame_999"].split);
            jQuery("#layer_endsplit_direction").val(objLayer.frames["frame_999"].split_direction);
            ...
            jQuery("#sfx_color_start").val(objLayer.frames["frame_0"].sfxcolor).tpColorPicker("refresh");
            ...
            jQuery("#layer_link_follow").val(objLayer.link_follow);
            ...
            jQuery("#sfx_color_end").val(objLayer.frames["frame_999"].sfxcolor).tpColorPicker("refresh");
            ...
            //jQuery("#letterspacing_start").val(objLayer.letterspacing_start);
            //jQuery("#letterspacing_end").val(objLayer.letterspacing_end);
            ...
            jQuery("#brightnessfilter_start").val(objLayer.brightnessfilter_start);
            jQuery("#brightnessfilter_end").val(objLayer.brightnessfilter_end);
            ...
            if(objLayer['static_styles'] != undefined){
                ...
                jQuery("#layer_color_s").val(t.getVal(objLayer['static_styles'], 'color')).tpColorPicker("refresh");
                        ...
                        switch(clayers[key]['layer_action']['action'][a]){
                            ...
                            case 'toggle_class':
                                ...
                                if(unique_id == target_layer){
                                    ...
                                    if(clayers[key]['layer_action']['link_follow'] && clayers[key]['layer_action']['link_follow'][a]) delete clayers[key]['layer_action']['link_follow'][a];
        ...
        t.add_layer_actions = function(obj){
            ...
            if(obj !== undefined && obj['layer_action'] !== undefined && obj['layer_action'].action !== undefined){
                ...
                for(var key in obj['layer_action'].action) if (obj['layer_action'].action.hasOwnProperty(key)) {
                    ...
                    data.link_follow = (obj['layer_action'].link_follow !== undefined && obj['layer_action'].link_follow[key] !== undefined) ? obj['layer_action'].link_follow[key] : 'same';
        ...
        t.checkAvailableAnimationFields = function() {
            if (jQuery.inArray(jQuery('#layer_animation').val(),["blockfromleft","blockfromright","blockfromtop","blockfrombottom"])>=0) {
                jQuery('.show-on-sfx_in, .hide-on-sfx_in, #add_customanimation_in').addClass("activestatus");
                jQuery('.show-on-sfx_in, #add_customanimation_in').addClass("activestatus");
                jQuery('#sfx_in_effect').val(jQuery('#layer_animation').val());
            } else {
                jQuery('.show-on-sfx_in, .hide-on-sfx_in, #add_customanimation_in').removeClass("activestatus");
                jQuery('#sfx_in_effect').val("");
            }

            if (jQuery.inArray(jQuery('#layer_endanimation').val(),["blocktoleft","blocktoright","blocktotop","blocktobottom"])>=0) {
                jQuery('.show-on-sfx_out, .hide-on-sfx_out, #add_customanimation_out').addClass("activestatus");
                jQuery('#sfx_out_effect').val(jQuery('#layer_endanimation').val());
            } else {
                jQuery('.show-on-sfx_out, .hide-on-sfx_out, #add_customanimation_out').removeClass("activestatus");
                jQuery('#sfx_out_effect').val("");
            }
        }
