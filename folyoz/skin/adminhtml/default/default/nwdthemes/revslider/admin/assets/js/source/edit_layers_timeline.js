    ...
    tpLayerTimelinesRev = new function() {
        ...
        function theLayerInAnimation(nextcaption) {
            ...
            if ($sfx!==false) {
                ...
                if (animobject.length>1) {
                    ...
                    for (var si in animobject) if (animobject.hasOwnProperty(si)) {
                        var $fanim = jQuery.extend({},animfrom,true),
                            $tanim = jQuery.extend({},animto,true);
                        for (var k in cycles.from) if (cycles.from.hasOwnProperty(k)) {
            ...
            if ($sfx!==false) {
                ...
                if (animobject.length>1) {
                    ...
                    for (var si in animobject) if (animobject.hasOwnProperty(si)) {
                        ...
                        for (var k in cycles.to) if (cycles.to.hasOwnProperty(k)) {
        ...
        t.updateTLFrame = function (frame, source, ignorerecursive, resizewidth) {
            ...
            if (fi !== 999) {
                ...
                var nfi="frame_0";
                for (var fri in objLayer.frames) if (objLayer.frames.hasOwnProperty(fri)) {
                    if (fri!=="frame_999")
                        nfi = fri;
                }
